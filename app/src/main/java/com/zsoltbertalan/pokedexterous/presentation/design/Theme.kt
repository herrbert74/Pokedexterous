package com.zsoltbertalan.pokedexterous.presentation.design
...
fun PokedexTheme(
	...
	val colorScheme = when {
		...
		isDarkTheme -> PokedexDarkColorScheme
...
val Dimens: Dimensions
	@Composable
	get() = PokedexTheme.dimens

val Colors: ColorScheme
	@Composable
	get() = PokedexTheme.colorScheme
